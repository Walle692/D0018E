...
func CreateBasketItem(c *gin.Context, basketID int, productID int, quantity int) error {
	...
	query = "INSERT INTO myschema.basketitem (basket_id, product_id, quantity, price) VALUES ($1, $2, $3, $4)"
	_, err = postgres.Pool().Exec(ctx, query, basketID, productID, quantity, price)
	if err != nil {
