<template>
  <div class="page">
    <div class="card">
      <div class="card__header">Find orders with your products</div>
...
import { searchSellerOrders } from '@/services/orders'
...
const searchType = ref('product_id')
...
async function runSearch(resetOffset = false) {
  ...
  try {
    orders.value = await searchSellerOrders({
